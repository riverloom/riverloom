...
const content = serviceContents["cloud-devops"];
...
export default function CloudDevOpsPage() {
  const breadcrumbs = [
    ...
    { name: "Cloud & DevOps", item: "/services/cloud-devops" },
  ];
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ ...serviceSchema(content.title, content.description, "/services/cloud-devops"), "@context": "https://schema.org" }) }} />
